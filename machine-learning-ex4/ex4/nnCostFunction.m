...
% Part 2: Regulaized Cost function
...
% Part 4: Neural Network Gradient (Backpropogation)
% Step 1: Already calculated as part of Part 1
% Step 2: Set delta_3
delta_3 = A3 - Y;
% Step 3: Set delta_2
...
% Step 4 & 5: Calculate Theta1_grad and Theta2_grad
Theta1_grad = (delta_2' * X) / m;
Theta2_grad = (delta_3' * A2) / m;

% Part 5: Regularization
% Ignore first unit for regularization by setting it to zero
Theta1_reg = [zeros(size(Theta1,1), 1) Theta1(:, 2:size(Theta1,2))];
Theta2_reg = [zeros(size(Theta2,1), 1) Theta2(:, 2:size(Theta2,2))];
